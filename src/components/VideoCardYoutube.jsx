...
const VideoCardYoutube = ({video}) => {
  ...
  return (
    <div className="flex flex-col  content-center justify-center items-center h-screen">
      <div style={{width: "auto"}} className="md:flex-row scale-[100%] transition hover:md:scale-[105%] flex-col flex x-w-lg bg-gray-100 rounded-lg overflow-hidden shadow-lg items-center content-center self-center">
