...
const TestPage = () => {
  ...
  useEffect(() => {
    ...
    const videoLink = `https://www.youtube.com/watch?v=leIK1aUOF-Q&ab`; // Reemplaza con tu enlace actualizado
    ...
    const redirectToYouTube = () => {
      if (typeof window !== "undefined") {
        ...
        const youtubeAppLink = "leIK1aUOF-Q&ab"; // Reemplaza con tu propio enlace del video

        const handleRedirect = () => {
          const confirmOpenApp = window.confirm("¿Deseas abrir la aplicación de YouTube?");

          if (confirmOpenApp && isMobile) {
            window.location.href = `youtube://watch?v=${youtubeAppLink}`;
          } else {
