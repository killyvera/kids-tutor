  ...
  return (
    <div class="bg-gray-100">
      <div class="mx-auto pt-20">
        ...
        <p class="mb-4">Fecha de última actualización: [Fecha]</p>

        <div class="bg-white rounded-lg shadow-md p-6 mb-4">
          <h2 class="text-xl font-bold mb-2">1. Uso del sitio web</h2>
          <p class="mb-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-4">
          <h2 class="text-xl font-bold mb-2">2. Responsabilidad del usuario</h2>
          <p class="mb-4">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-4">
          <h2 class="text-xl font-bold mb-2">3. Propiedad intelectual</h2>
          <p class="mb-4">
