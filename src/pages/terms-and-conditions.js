...
const TermsAndConditions = () => {
  return (
    <Layout>
      <div className="bg-gray-100 py-4 md:px-8 pt-10">
        <div className="max-w-3xl mx-auto  style={{maxWidth: '80%'}}">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-4">
            ...
            <p className="mb-4">
              ...
              informativos y educativos. No se garantiza la precisión,
              integridad o actualidad de la información.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-4">
            ...
            <p className="mb-4">
              ...
              credenciales de inicio de sesión y de cualquier actividad que
              ocurra bajo tu cuenta. No puedes compartir tu cuenta con terceros
              ni utilizar cuentas de otros usuarios sin autorización.
            </p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 mb-4">
            ...
            <p className="mb-4">
              ...
              materiales en KidsTutor.co son propiedad exclusiva de
              KidsTutor.co, a menos que se indique lo contrario. No puedes
              utilizar, reproducir, modificar, distribuir o transmitir ningún
              contenido de KidsTutor.co sin nuestro consentimiento expreso por
              escrito.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-4">
            ...
            <p className="mb-4">
              KidsTutor.co puede contener enlaces a sitios web de terceros que
              no están bajo nuestro control. No nos responsabilizamos de la
          ...
          <div className="bg-white rounded-lg shadow-md p-6 mb-4">
            ...
            <p className="mb-4">
              ...
              indirecto, incidental, especial o consecuente que surja del uso o
              la incapacidad de utilizar nuestros servicios. No ofrecemos
              garantías ni representaciones con respecto a la precisión o
          ...
          <p className="mt-4">
            ...
            condiciones, no dudes en contactarnos a través de [dirección de
