...
export default function MyFooter(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "MyFooter")}
      {...rest}
    >
      <View
        width="1440px"
      ...
      <Text
        ...
        {...getOverrideProps(overrides, "bottomText1")}
      ></Text>
      <Flex
        gap="24px"
        direction="row"
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "linkGroup1")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
          ...
          <Text
            ...
            {...getOverrideProps(overrides, "link4")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            {...getOverrideProps(overrides, "link5")}
          ></Text>
        </Flex>
        <Flex
          gap="8px"
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "linkGroup2")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
          ...
          <Text
            ...
            whiteSpace="pre-wrap"
            children="Consectetur adipiscing"
            {...getOverrideProps(overrides, "Consectetur adipiscing")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            whiteSpace="pre-wrap"
            children="Elit sed do eiusmod"
            {...getOverrideProps(overrides, "Elit sed do eiusmod")}
          ></Text>
        </Flex>
      </Flex>
      <Text
        ...
        {...getOverrideProps(overrides, "trademark")}
      ></Text>
      <Flex
        gap="16px"
        direction="column"
