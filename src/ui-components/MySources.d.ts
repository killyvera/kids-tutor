...
export declare type MySourcesOverridesProps = {
    MySources?: PrimitiveOverrideProps<ViewProps>;
...
export declare type MySourcesProps = React.PropsWithChildren<Partial<ViewProps> & {
    breakpoint?: "large" | "small";
} & {
    overrides?: MySourcesOverridesProps | undefined | null;
}>;
export default function MySources(props: MySourcesProps): React.ReactElement;
